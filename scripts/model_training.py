...
from utils.train import create_pipeline, define_hyperparam_space, load_train_valid_data, tune_hyperparameters
from utils.visualisation import plot_confusion_matrix, plot_feature_importance, plot_permutation_importance, plot_roc_curve, plot_shap_values
...
def main():
    ...
    """
    # Setup directories
    transformed_data_dir, output_data_dir, evaluation_dir, metrics_dir = setup_directories(current_location)

    # Setup MLflow experiment
    experiment_id = get_or_create_experiment(experiment_name="EmployeeAttrition_Experiment", current_location=current_location)
